...
amdgcn.module @test_copies target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  ...
  amdgcn.kernel @test_global_load_wave arguments <[
    ...
    amdgcn.flat.global_store #amdgcn.inst<global_store_dword> %loaded_vx1, %out_ptr_vx1[%out_off_vx1]
      : !vx1, !sx2[!v]
    ...
    amdgcn.flat.global_store #amdgcn.inst<global_store_dwordx2> %loaded_vx2, %out_ptr_vx2[%out_off_vx2]
      : !vx2, !sx2[!v]
    amdgcn.sopp.s_waitcnt #amdgcn.inst<s_waitcnt> vmcnt = 0
    ...
    amdgcn.flat.global_store #amdgcn.inst<global_store_dwordx3> %loaded_vx3, %out_ptr_vx3[%out_off_vx3]
      : !vx3, !sx2[!v]
    amdgcn.sopp.s_waitcnt #amdgcn.inst<s_waitcnt> vmcnt = 0
    ...
    amdgcn.flat.global_store #amdgcn.inst<global_store_dwordx4> %loaded_vx4, %out_ptr_vx4[%out_off_vx4]
      : !vx4, !sx2[!v]
    amdgcn.sopp.s_waitcnt #amdgcn.inst<s_waitcnt> vmcnt = 0
