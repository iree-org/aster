...
amdgcn.module @test_copies target = #amdgcn.target<gfx942> {
  ...
  func.func private @global_load_wave_384_f16_via_dwordx3_wait(!tensor_position_descriptor_2level_2d, !transfer_descriptor_2d) -> (!vx3)
  func.func private @global_load_wave_512_f16_via_dwordx4_wait(!tensor_position_descriptor_2level_2d, !transfer_descriptor_2d) -> (!vx4)
  ...
  amdgcn.kernel @test_global_load_wave arguments <[
    ...
    %tok_store_1 = amdgcn.global_store_dword ins(%loaded_vx1, %out_ptr_vx1, offset = %out_off_vx1) args(%c0_i32_mig1)
        : ins(!vx1, !sx2, offset = !v) args(i32) -> !amdgcn.write_token<flat>
    ...
    %tok_store_2 = amdgcn.global_store_dwordx2 ins(%loaded_vx2, %out_ptr_vx2, offset = %out_off_vx2) args(%c0_i32_mig2)
    ...
    %tok_store_3 = amdgcn.global_store_dwordx3 ins(%loaded_vx3, %out_ptr_vx3, offset = %out_off_vx3) args(%c0_i32_mig3)
    ...
    %tok_store_4 = amdgcn.global_store_dwordx4 ins(%loaded_vx4, %out_ptr_vx4, offset = %out_off_vx4) args(%c0_i32_mig4)
