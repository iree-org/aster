...
amdgcn.module @test_copies target = #amdgcn.target<gfx942> isa = #amdgcn.isa<cdna3> {
  ...
  //===--------------------------------------------------------------------===//
  // copies.mlir
  func.func private @global_load_wave_128xf16_via_dword_wait(!tensor_position_descriptor_2level_2d, index) -> (!vx1)
  func.func private @global_load_wave_256xf16_via_dwordx2_wait(!tensor_position_descriptor_2level_2d, index) -> (!vx2)
  func.func private @global_load_wave_384xf16_via_dwordx3_wait(!tensor_position_descriptor_2level_2d, index) -> (!vx3)
  func.func private @global_load_wave_512xf16_via_dwordx4_wait(!tensor_position_descriptor_2level_2d, index) -> (!vx4)
  ...
  amdgcn.kernel @test_global_load_wave arguments <[
    ...
    %loaded_vx1 = func.call @global_load_wave_128xf16_via_dword_wait(%pos_desc_vx1, %c1) : (!tensor_position_descriptor_2level_2d, index) -> (!vx1)
    ...
    %loaded_vx2 = func.call @global_load_wave_256xf16_via_dwordx2_wait(%pos_desc_vx2, %c1) : (!tensor_position_descriptor_2level_2d, index) -> (!vx2)
    ...
    %loaded_vx3 = func.call @global_load_wave_384xf16_via_dwordx3_wait(%pos_desc_vx3, %c1) : (!tensor_position_descriptor_2level_2d, index) -> (!vx3)
    ...
    %loaded_vx4 = func.call @global_load_wave_512xf16_via_dwordx4_wait(%pos_desc_vx4, %c1) : (!tensor_position_descriptor_2level_2d, index) -> (!vx4)
