...
amdgcn.module @test_global_load_ds_write target = #amdgcn.target<gfx942> {
  ...
  amdgcn.kernel @test_global_load_ds_write arguments <[
    ...
    %from_lds, %tok_read = amdgcn.ds_read_b64 outs(%dst) ins(%lds_off_vgpr) args(%c0_i32)
    ...
    %tok_store = amdgcn.global_store_dwordx2 ins(%from_lds, %out_ptr, offset = %out_off_vgpr) args(%c0_i32)
