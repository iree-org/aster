"""Unit tests for maybe_global_store_wave_16x16xf32_C_fragment from conditional-copies.mlir."""
...
class TestMaybeStoreCFragment:
    """Test the maybe_global_store_wave_16x16xf32_C_fragment library function.
    ...
    def _run_test(self, mm: int, nn: int, k: int, kk: int):
        ...
        compile_and_run(
            "test_maybe_global_store_wave_16x16xf32_C_fragment.mlir",
            "test_maybe_global_store_wave_16x16xf32_C_fragment",
            [],
            output,
