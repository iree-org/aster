...
amdgcn.module @test_indexing target = #amdgcn.target<gfx942> {
  ...
  func.func private @store_at_tid(%value: i32, %ptr: !sx2, %index_offset: index) {
    ...
    %tok_store = amdgcn.global_store_dword ins(%value_vgpr, %ptr, offset = %offset_vgpr) args(%c0)
  ...
  func.func private @store_pair_at_tid(%v0: i32, %v1: i32, %ptr: !sx2, %index_offset: index) {
    ...
    %tok_store0 = amdgcn.global_store_dword ins(%v0_vgpr, %ptr, offset = %offset0_vgpr) args(%c0_pair)
        : ins(!v, !sx2, offset = !v) args(i32) -> !amdgcn.write_token<flat>
    ...
    %tok_store1 = amdgcn.global_store_dword ins(%v1_vgpr, %ptr, offset = %offset1_vgpr) args(%c0_pair)
        : ins(!v, !sx2, offset = !v) args(i32) -> !amdgcn.write_token<flat>
  ...
  amdgcn.kernel @test_matrix_offset arguments <[
    ...
    %tok1 = amdgcn.global_store_dword ins(%off_vgpr, %out_ptr, offset = %out_offset_vgpr) args(%c0_mo)
        : ins(!v, !sx2, offset = !v) args(i32) -> !amdgcn.write_token<flat>
    amdgcn.s_waitcnt vmcnt = 0
    amdgcn.end_kernel
  }
  ...
  amdgcn.kernel @test_tiled_matrix_offset arguments <[
    ...
    %tok2 = amdgcn.global_store_dword ins(%off_vgpr, %out_ptr, offset = %out_offset_vgpr) args(%c0_tmo)
        : ins(!v, !sx2, offset = !v) args(i32) -> !amdgcn.write_token<flat>
    amdgcn.s_waitcnt vmcnt = 0
    amdgcn.end_kernel
  }
  ...
  amdgcn.kernel @test_tiledx2_matrix_offset arguments <[
    ...
    %tok3 = amdgcn.global_store_dword ins(%off_vgpr, %out_ptr, offset = %out_offset_vgpr) args(%c0_tx2)
        : ins(!v, !sx2, offset = !v) args(i32) -> !amdgcn.write_token<flat>
    amdgcn.s_waitcnt vmcnt = 0
    amdgcn.end_kernel
  }
