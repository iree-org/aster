...
amdgcn.module @test_store_global_C_fragment target = #amdgcn.target<gfx942> {
  ...
  // Test @global_store_wave_16x16_f32_C_fragment_wait: store C fragment to global
  ...
  amdgcn.kernel @test_store_global_C_fragment_wait arguments <[
    ...
    func.call @global_store_wave_16x16_f32_C_fragment_wait(%acc, %pos_desc, %false) : (!vx4, !tensor_position_descriptor_2level_2d, i1) -> ()
