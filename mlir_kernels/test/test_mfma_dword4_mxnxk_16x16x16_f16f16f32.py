...
@pytest.mark.parametrize(
    ...
    [
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 1, 1, 1, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 1, 1, 2, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 2, 1, 2, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 1, 2, 2, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 2, 2, 1, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 2, 2, 2, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 3, 3, 3, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 4, 4, 4, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 1, 4, 4, 6, DEFAULT_SROA_PASS_PIPELINE),
        # Test with multiple workgroups and waves
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         2, 1, 1, 1, 1, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         2, 1, 2, 2, 2, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 2, 1, 1, 1, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         1, 2, 2, 2, 2, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         2, 2, 1, 1, 1, DEFAULT_SROA_PASS_PIPELINE),
        ("mfma_dword4_mxnxk_16x16x16_f16f16f32.mlir", "test_matmul_kernel",
         2, 2, 2, 2, 2, DEFAULT_SROA_PASS_PIPELINE),
    ],
    # fmt: on
)
@pytest.mark.parametrize("mcpu", ["gfx942"])
def test_mfma_e2e_kernel(
    mlir_filename, kernel_name: str, num_workgroups, num_waves, m, n, k, pass_pipeline, mcpu, wavefront_size=64
):
    ...
    # Try mlir_kernels directory first, then test/integration
    ...
    with ir.Context() as ctx:
        ...
        asm_complete, module_after_passes = compile_mlir_file_to_asm(
            mlir_file, kernel_name, pass_pipeline, ctx, preprocess=preprocess
        )
