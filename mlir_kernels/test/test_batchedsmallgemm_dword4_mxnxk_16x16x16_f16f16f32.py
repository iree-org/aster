...
@pytest.mark.parametrize(
    ...
    [
        (FILE_NAME, KERNEL_NAME, 1, 1, 1, 1, 1, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 1, 1, 2, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 2, 1, 2, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 1, 2, 2, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 2, 2, 1, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 2, 2, 2, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 3, 3, 3, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 4, 4, 4, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 1, 4, 4, 6, "test-sroa"),
        # Test with multiple workgroups and waves
        (FILE_NAME, KERNEL_NAME, 2, 1, 1, 1, 1, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 2, 1, 2, 2, 2, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 2, 1, 1, 1, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 1, 2, 2, 2, 2, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 2, 2, 1, 1, 1, "test-sroa"),
        (FILE_NAME, KERNEL_NAME, 2, 2, 2, 2, 2, "test-sroa"),
    ],
    # fmt: on
)
