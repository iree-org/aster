  ...
  // TODO: add a static assert to enforce these.
   func.func private @global_load_wave_elt_2d_wait_impl(
    ...
    case 4 {
        ...
        %loaded = amdgcn.flat.global_load <global_load_dword> %dst, %ptr[%off_reg]
          : !vx1, !sx2[!v] -> !vx1
    ...
    case 12 {
        ...
        %loaded = amdgcn.flat.global_load <global_load_dwordx3> %dst, %ptr[%off_reg]
          : !vx3, !sx2[!v] -> !vx3
    ...
    case 16 {
        ...
        %loaded = amdgcn.flat.global_load <global_load_dwordx4> %dst, %ptr[%off_reg]
          : !vx4, !sx2[!v] -> !vx4
