...
amdgcn.library @simple_copies isa = [#amdgcn.isa<cdna3>] {
  ...
  func.func private @simple_global_load_wave_16x16_f16_wait(
    ...
    %from_global, %tok_load = amdgcn.global_load_dwordx2 outs(%dst) ins(%ptr, offset = %off_reg) args(%c0)
  ...
  func.func private @simple_global_store_wave_16x16_f16_wait(
    ...
    %c0 = arith.constant 0 : i32
    %tok_store = amdgcn.global_store_dwordx2 ins(%value, %ptr, offset = %off_reg) args(%c0)
  ...
  func.func private @simple_lds_write_wave_16x16_f16_wait(
    ...
    %lds_base_i32 = arith.index_cast %lds_base : index to i32
    %tok_write = amdgcn.ds_write_b64 ins(%off_lds_reg, %value) args(%lds_base_i32)
