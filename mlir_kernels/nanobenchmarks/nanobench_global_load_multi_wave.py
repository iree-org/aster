#!/usr/bin/env python3
"""Nanobenchmark for @global_load_wave with multiple waves per block."""
...
KERNEL_NAME = "nanobench_global_load_multi_wave"
MCPU = "gfx942"
WAVEFRONT_SIZE = 64

def main():
    parser = argparse.ArgumentParser(
        description="Nanobenchmark for global load with multiple waves"
    )
    parser.add_argument(
        "--num-iters",
        type=int,
    ...
    mlir_file = os.path.join(script_dir, "nanobench_global_load_multi_wave.mlir")
