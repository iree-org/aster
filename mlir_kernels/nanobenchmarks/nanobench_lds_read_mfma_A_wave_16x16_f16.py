#!/usr/bin/env python3
"""Nanobenchmark for @lds_read_A_wave_16x16_f16_fragment_wait."""
...
KERNEL_NAME = "nanobench_lds_read_mfma_A_wave_16x16_f16"
LDS_SIZE = 16384
...
def main():
    parser = argparse.ArgumentParser(
        description="Nanobenchmark for LDS read A wave 16x16_f16 fragment"
    )
    ...
    mlir_file = os.path.join(
        script_dir, "nanobench_lds_read_mfma_A_wave_16x16_f16.mlir"
    )
    ...
    config = NanobenchConfig(
        ...
        description="LDS read MFMA A wave 16x16_f16 benchmark",
