...
module {
  amdgcn.module @nop_demo target = <gfx942> {
    ...
    ^entry:
      ...
      amdgcn.s_load_dwordx2 outs(%out_ptr) ins(%kernarg) args(%c0_i32_mig1)
      ...
      amdgcn.global_store_dword ins(%data_r, %out_ptr, offset = %v1) args(%c0)
          : ins(!amdgcn.vgpr<[0 : 1]>, !amdgcn.sgpr<[2 : 4]>, offset = !amdgcn.vgpr<1>) args(i32) -> !amdgcn.write_token<flat>
