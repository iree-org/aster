//===- ThreadUniformAnalysis.h - Thread uniform analysis ------------------===//
//
...
#ifndef ASTER_ANALYSIS_THREADUNIFORMANALYSIS_H
#define ASTER_ANALYSIS_THREADUNIFORMANALYSIS_H
...
public:
  ...
  void visitCallableOperation(
      ...
      ArrayRef<mlir::dataflow::AbstractSparseLattice *> argLattices) override;
};
} // namespace mlir::aster::dataflow

MLIR_DECLARE_EXPLICIT_TYPE_ID(mlir::aster::dataflow::ThreadUniformLattice)

#endif // ASTER_ANALYSIS_THREADUNIFORMANALYSIS_H
