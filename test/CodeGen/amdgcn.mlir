...
// CHECK-LABEL:   func.func private @test_mfma_f32_16x16x32_fp8_fp8(
// CHECK-SAME:      %[[A:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[B:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[C:.*]]: !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]> {
// CHECK:           %[[RESULT:.*]] = amdgcn.vop3p.vop3p_mai <v_mfma_f32_16x16x32_fp8_fp8> %[[C]], %[[A]], %[[B]], %[[C]] : <[? + 2]>, <[? + 2]>, !amdgcn.vgpr_range<[? + 4]> -> !amdgcn.vgpr_range<[? + 4]>
// CHECK:           return %[[RESULT]] : !amdgcn.vgpr_range<[? + 4]>
// CHECK:         }
func.func private @test_mfma_f32_16x16x32_fp8_fp8(%a: vector<8xf8E4M3FNUZ>, %b: vector<8xf8E4M3FNUZ>, %c: vector<4xf32>) -> vector<4xf32>
    attributes {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} {
  %result = amdgpu.mfma 16x16x32 %a * %b + %c blgp = none : vector<8xf8E4M3FNUZ>, vector<8xf8E4M3FNUZ>, vector<4xf32>
  return {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} %result : vector<4xf32>
}

// CHECK-LABEL:   func.func private @test_mfma_f32_16x16x32_fp8_bf8(
// CHECK-SAME:      %[[A:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[B:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[C:.*]]: !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]> {
// CHECK:           %[[RESULT:.*]] = amdgcn.vop3p.vop3p_mai <v_mfma_f32_16x16x32_fp8_bf8> %[[C]], %[[A]], %[[B]], %[[C]] : <[? + 2]>, <[? + 2]>, !amdgcn.vgpr_range<[? + 4]> -> !amdgcn.vgpr_range<[? + 4]>
// CHECK:           return %[[RESULT]] : !amdgcn.vgpr_range<[? + 4]>
// CHECK:         }
func.func private @test_mfma_f32_16x16x32_fp8_bf8(%a: vector<8xf8E4M3FNUZ>, %b: vector<8xf8E5M2FNUZ>, %c: vector<4xf32>) -> vector<4xf32>
    attributes {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} {
  %result = amdgpu.mfma 16x16x32 %a * %b + %c blgp = none : vector<8xf8E4M3FNUZ>, vector<8xf8E5M2FNUZ>, vector<4xf32>
  return {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} %result : vector<4xf32>
}

// CHECK-LABEL:   func.func private @test_mfma_f32_16x16x32_bf8_fp8(
// CHECK-SAME:      %[[A:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[B:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[C:.*]]: !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]> {
// CHECK:           %[[RESULT:.*]] = amdgcn.vop3p.vop3p_mai <v_mfma_f32_16x16x32_bf8_fp8> %[[C]], %[[A]], %[[B]], %[[C]] : <[? + 2]>, <[? + 2]>, !amdgcn.vgpr_range<[? + 4]> -> !amdgcn.vgpr_range<[? + 4]>
// CHECK:           return %[[RESULT]] : !amdgcn.vgpr_range<[? + 4]>
// CHECK:         }
func.func private @test_mfma_f32_16x16x32_bf8_fp8(%a: vector<8xf8E5M2FNUZ>, %b: vector<8xf8E4M3FNUZ>, %c: vector<4xf32>) -> vector<4xf32>
    attributes {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} {
  %result = amdgpu.mfma 16x16x32 %a * %b + %c blgp = none : vector<8xf8E5M2FNUZ>, vector<8xf8E4M3FNUZ>, vector<4xf32>
  return {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} %result : vector<4xf32>
}

// CHECK-LABEL:   func.func private @test_mfma_f32_16x16x32_bf8_bf8(
// CHECK-SAME:      %[[A:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[B:.*]]: !amdgcn.vgpr_range<[? + 2]>, %[[C:.*]]: !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]> {
// CHECK:           %[[RESULT:.*]] = amdgcn.vop3p.vop3p_mai <v_mfma_f32_16x16x32_bf8_bf8> %[[C]], %[[A]], %[[B]], %[[C]] : <[? + 2]>, <[? + 2]>, !amdgcn.vgpr_range<[? + 4]> -> !amdgcn.vgpr_range<[? + 4]>
// CHECK:           return %[[RESULT]] : !amdgcn.vgpr_range<[? + 4]>
// CHECK:         }
func.func private @test_mfma_f32_16x16x32_bf8_bf8(%a: vector<8xf8E5M2FNUZ>, %b: vector<8xf8E5M2FNUZ>, %c: vector<4xf32>) -> vector<4xf32>
    attributes {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} {
  %result = amdgpu.mfma 16x16x32 %a * %b + %c blgp = none : vector<8xf8E5M2FNUZ>, vector<8xf8E5M2FNUZ>, vector<4xf32>
  return {abi = (!amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr_range<[? + 4]>) -> !amdgcn.vgpr_range<[? + 4]>} %result : vector<4xf32>
}
