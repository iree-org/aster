...
// CHECK-SAME:  [#aster_test.no_index_types]
normalform.module @no_index_types_valid [#aster_test.no_index_types] {
...
// CHECK-SAME:  [#aster_test.no_invalid_ops]
...
// CHECK-SAME:  [#aster_test.no_invalid_attrs]
normalform.module @no_invalid_attrs_valid [#aster_test.no_invalid_attrs] {
...
// CHECK-SAME:  [#aster_test.no_index_types, #aster_test.no_invalid_ops]
...
// CHECK-SAME:  [#aster_test.no_index_types, #aster_test.no_invalid_ops, #aster_test.no_invalid_attrs]
normalform.module @all_attrs_valid [#aster_test.no_index_types, #aster_test.no_invalid_ops, #aster_test.no_invalid_attrs] {
...
// CHECK-LABEL: normalform.module [#aster_test.no_invalid_ops]
