...
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_mfma_f32_16x16x16_f16 outs(%[[ARG3]]) ins(%[[ARG0]], %[[ARG1]], %[[MAKE_REGISTER_RANGE_0]]) : outs(!amdgcn.vgpr<[8 : 12]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
// CHECK:           return
// CHECK:         }
func.func @mma_nondlops_valu_mfma_hazard(%arg0: !amdgcn.vgpr<[0 : 2]>, %arg1: !amdgcn.vgpr<[2 : 4]>, %arg2: !amdgcn.vgpr<[4 : 8]>, %arg3: !amdgcn.vgpr<[8 : 12]>, %arg4: !amdgcn.vgpr<16>) {
  ...
  amdgcn.v_mfma_f32_16x16x16_f16 outs(%arg3) ins(%arg0, %arg1, %1)
...
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_mfma_f32_16x16x16_f16 outs(%[[ARG4]]) ins(%[[MAKE_REGISTER_RANGE_0]], %[[ARG2]], %[[ARG3]]) : outs(!amdgcn.vgpr<[8 : 12]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
// CHECK:           return
// CHECK:         }
func.func @mma_nondlops_valu_mfma_srca_hazard(%arg0: !amdgcn.vgpr<0>, %arg1: !amdgcn.vgpr<1>, %arg2: !amdgcn.vgpr<[2 : 4]>, %arg3: !amdgcn.vgpr<[4 : 8]>, %arg4: !amdgcn.vgpr<[8 : 12]>, %arg5: !amdgcn.vgpr<16>) {
  ...
  amdgcn.v_mfma_f32_16x16x16_f16 outs(%arg4) ins(%0, %arg2, %arg3)
    : outs(!amdgcn.vgpr<[8 : 12]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
  return
}
...
// CHECK:           amdgcn.v_mfma_f32_16x16x16_f16 outs(%[[ARG3]]) ins(%[[ARG0]], %[[ARG1]], %[[ARG2]]) : outs(!amdgcn.vgpr<[8 : 12]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
// CHECK:           amdgcn.v_mfma_f32_16x16x16_f16 outs(%[[ARG4]]) ins(%[[ARG0]], %[[ARG1]], %[[ARG3]]) : outs(!amdgcn.vgpr<[12 : 16]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[8 : 12]>)
// CHECK:           return
// CHECK:         }
func.func @mma_xdl_write_xdl_read_srcc_exact_hazard(%arg0: !amdgcn.vgpr<[0 : 2]>, %arg1: !amdgcn.vgpr<[2 : 4]>, %arg2: !amdgcn.vgpr<[4 : 8]>, %arg3: !amdgcn.vgpr<[8 : 12]>, %arg4: !amdgcn.vgpr<[12 : 16]>) {
  amdgcn.v_mfma_f32_16x16x16_f16 outs(%arg3) ins(%arg0, %arg1, %arg2)
    : outs(!amdgcn.vgpr<[8 : 12]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
  amdgcn.v_mfma_f32_16x16x16_f16 outs(%arg4) ins(%arg0, %arg1, %arg3)
    : outs(!amdgcn.vgpr<[12 : 16]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[8 : 12]>)
  return
}
...
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_mfma_f32_16x16x16_f16 outs(%[[ARG4]]) ins(%[[MAKE_REGISTER_RANGE_0]], %[[ARG1]], %[[ARG5]]) : outs(!amdgcn.vgpr<[12 : 16]>) ins(!amdgcn.vgpr<[8 : 10]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[16 : 20]>)
// CHECK:           return
// CHECK:         }
func.func @mma_xdl_write_mfma_read_srca(%arg0: !amdgcn.vgpr<[0 : 2]>, %arg1: !amdgcn.vgpr<[2 : 4]>, %arg2: !amdgcn.vgpr<[4 : 8]>, %arg3: !amdgcn.vgpr<[8 : 12]>, %arg4: !amdgcn.vgpr<[12 : 16]>, %arg5: !amdgcn.vgpr<[16 : 20]>) {
  ...
  amdgcn.v_mfma_f32_16x16x16_f16 outs(%arg4) ins(%1, %arg1, %arg5)
    : outs(!amdgcn.vgpr<[12 : 16]>)
      ins(!amdgcn.vgpr<[8 : 10]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[16 : 20]>)
  return
}
...
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_mfma_f32_16x16x16_f16 outs(%[[ARG4]]) ins(%[[ARG0]], %[[MAKE_REGISTER_RANGE_0]], %[[ARG3]]) : outs(!amdgcn.vgpr<[8 : 12]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
// CHECK:           return
// CHECK:         }
func.func @mma_nondlops_valu_mfma_srcb_hazard(%arg0: !amdgcn.vgpr<[0 : 2]>, %arg1: !amdgcn.vgpr<2>, %arg2: !amdgcn.vgpr<3>, %arg3: !amdgcn.vgpr<[4 : 8]>, %arg4: !amdgcn.vgpr<[8 : 12]>, %arg5: !amdgcn.vgpr<16>) {
  ...
  amdgcn.v_mfma_f32_16x16x16_f16 outs(%arg4) ins(%arg0, %0, %arg3)
    : outs(!amdgcn.vgpr<[8 : 12]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[4 : 8]>)
  return
}
...
// CHECK:           amdgcn.v_mfma_f32_32x32x8_f16 outs(%[[ARG3]]) ins(%[[ARG0]], %[[ARG1]], %[[ARG2]]) : outs(!amdgcn.vgpr<[32 : 48]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[16 : 32]>)
...
func.func @mma_32x32x8_xdl_write_valu_hazard(%arg0: !amdgcn.vgpr<[0 : 2]>, %arg1: !amdgcn.vgpr<[2 : 4]>, %arg2: !amdgcn.vgpr<[16 : 32]>, %arg3: !amdgcn.vgpr<[32 : 48]>, %arg4: !amdgcn.vgpr<48>) {
  amdgcn.v_mfma_f32_32x32x8_f16 outs(%arg3) ins(%arg0, %arg1, %arg2)
    : outs(!amdgcn.vgpr<[32 : 48]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[16 : 32]>)
...
// CHECK:           amdgcn.v_mfma_f32_32x32x8_f16 outs(%[[ARG4]]) ins(%[[ARG0]], %[[ARG1]], %[[ARG3]]) : outs(!amdgcn.vgpr<[48 : 64]>) ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[32 : 48]>)
// CHECK:           return
// CHECK:         }
func.func @mma_32x32x8_xdl_write_xdl_read_srcc_exact(%arg0: !amdgcn.vgpr<[0 : 2]>, %arg1: !amdgcn.vgpr<[2 : 4]>, %arg2: !amdgcn.vgpr<[16 : 32]>, %arg3: !amdgcn.vgpr<[32 : 48]>, %arg4: !amdgcn.vgpr<[48 : 64]>) {
  amdgcn.v_mfma_f32_32x32x8_f16 outs(%arg3) ins(%arg0, %arg1, %arg2)
    : outs(!amdgcn.vgpr<[32 : 48]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[16 : 32]>)
  amdgcn.v_mfma_f32_32x32x8_f16 outs(%arg4) ins(%arg0, %arg1, %arg3)
    : outs(!amdgcn.vgpr<[48 : 64]>)
      ins(!amdgcn.vgpr<[0 : 2]>, !amdgcn.vgpr<[2 : 4]>, !amdgcn.vgpr<[32 : 48]>)
  return
}
