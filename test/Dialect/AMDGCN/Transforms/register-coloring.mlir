...
// -----
// Dead write to outs alloca must still interfere with live-through values.
//
// Here, %dead_target is written by test_inst but the result is never used
// (dead write). %live_through is live across the dead write, so they must get
// different registers.
//
...
// -----
// Dead copy to outs alloca must interfere with live-through values.
//
// This tests the pattern from pipelined loop epilogues where a copy chain
// writes to an alloca whose value is overwritten before being read.
//
