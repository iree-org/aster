...
// CHECK-LABEL: kernel @agpr_no_interference {
// CHECK:         %[[A0:.*]] = alloca : !amdgcn.agpr<0>
// CHECK:         test_inst outs %[[A0]] : (!amdgcn.agpr<0>) -> ()
// CHECK:         test_inst outs %[[A0]] : (!amdgcn.agpr<0>) -> ()
// CHECK:         end_kernel
amdgcn.module @agpr_no_interference_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @agpr_interference {
...
// CHECK:         end_kernel
amdgcn.module @agpr_interference_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @agpr_range_allocation {
// CHECK-DAG:     %[[A0:.*]] = alloca : !amdgcn.agpr<0>
// CHECK-DAG:     %[[A1:.*]] = alloca : !amdgcn.agpr<1>
...
// CHECK:         end_kernel
amdgcn.module @agpr_range_allocation_mod target = <gfx942> {
...
// CHECK:         end_kernel
amdgcn.module @agpr_copy_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @agpr_copy_with_vgprs {
...
// CHECK:         v_accvgpr_mov_b32 outs(%[[A0]]) ins(%[[A1]])
// CHECK:         end_kernel
amdgcn.module @agpr_copy_with_vgprs_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @mixed_vgpr_agpr_independent {
...
// CHECK:         test_inst ins %[[V]], %[[A]] : (!amdgcn.vgpr<0>, !amdgcn.agpr<0>) -> ()
// CHECK:         end_kernel
amdgcn.module @mixed_vgpr_agpr_independent_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @explicit_accvgpr_write_imm {
// CHECK-DAG:     %[[A:.*]] = alloca : !amdgcn.agpr<0>
// CHECK-DAG:     %[[V:.*]] = alloca : !amdgcn.vgpr<0>
...
// CHECK:         end_kernel
amdgcn.module @explicit_accvgpr_write_imm_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @explicit_accvgpr_write_from_vgpr {
// CHECK-DAG:     %[[V:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK-DAG:     %[[A:.*]] = alloca : !amdgcn.agpr<0>
...
// CHECK:         test_inst ins %[[V]] : (!amdgcn.vgpr<0>) -> ()
// CHECK:         end_kernel
amdgcn.module @explicit_accvgpr_write_from_vgpr_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @vgpr_to_agpr_copy_rejected {
// CHECK-DAG:     %[[V:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK-DAG:     %[[A:.*]] = alloca : !amdgcn.agpr<0>
// CHECK:         test_inst outs %[[V]] : (!amdgcn.vgpr<0>) -> ()
...
// CHECK:         end_kernel
amdgcn.module @vgpr_to_agpr_copy_rejected_mod target = <gfx942> {
...
// CHECK-LABEL: kernel @agpr_to_vgpr_copy_rejected {
// CHECK-DAG:     %[[A:.*]] = alloca : !amdgcn.agpr<0>
// CHECK-DAG:     %[[V:.*]] = alloca : !amdgcn.vgpr<0>
// CHECK:         test_inst outs %[[A]] : (!amdgcn.agpr<0>) -> ()
...
// CHECK:         test_inst ins %[[V]] : (!amdgcn.vgpr<0>) -> ()
// CHECK:         end_kernel
amdgcn.module @agpr_to_vgpr_copy_rejected_mod target = <gfx942> {
