...
func.func @test_if_flow_1(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  %2 = scf.if %arg1 -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%1) ins(%arg0) args(%c0_i32_mig8)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
...
func.func @test_if_flow_2(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  %2 = scf.if %arg1 -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig9)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig10 = arith.constant 0 : i32
    %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig10)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig11 = arith.constant 0 : i32
    %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig11)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token_3 : !amdgcn.read_token<flat>
  } else {
    %c0_i32_mig12 = arith.constant 0 : i32
    %result, %token = amdgcn.global_load_dword outs(%1) ins(%arg0) args(%c0_i32_mig12)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
  amdgcn.wait deps %2 : !amdgcn.read_token<flat>
...
func.func @test_if_flow_3(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  %2 = scf.if %arg1 -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig13)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig14 = arith.constant 0 : i32
    %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig14)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig15 = arith.constant 0 : i32
    %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig15)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  } else {
    %c0_i32_mig16 = arith.constant 0 : i32
    %result, %token = amdgcn.global_load_dword outs(%1) ins(%arg0) args(%c0_i32_mig16)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig17 = arith.constant 0 : i32
    %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig17)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
  amdgcn.wait deps %2 : !amdgcn.read_token<flat>
...
func.func @test_passthrough_pattern(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig18)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig19 = arith.constant 0 : i32
  %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig19)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig20 = arith.constant 0 : i32
  %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig20)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  amdgcn.wait deps %token : !amdgcn.read_token<flat>
...
func.func @test_mixed_smem_dsmem(%arg0: !amdgcn.sgpr<[? + 2]>, %arg1: !amdgcn.vgpr, %arg2: !amdgcn.vgpr<[? + 2]>) {
  ...
  %result_2, %token_3 = amdgcn.global_load_dword outs(%1) ins(%arg2) args(%c0_i32_mig21)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @test_mixed_smem_dsmem_vmem(%arg0: !amdgcn.sgpr<[? + 2]>, %arg1: !amdgcn.vgpr, %arg2: !amdgcn.vgpr<[? + 2]>) {
  ...
  %c4 = arith.constant 4 : index
  %c0_i32_mig2 = arith.constant 0 : i32
  %result, %token = amdgcn.s_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig2)
      : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
  %result_0, %token_1 = amdgcn.ds_read_b32 outs(%1) ins(%arg1) args(%c0_i32_mig2)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
...
func.func @test_mixed_iter_args(%arg0: !amdgcn.vgpr<[? + 2]>) -> index {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig29)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %out:2 = scf.for %i = %c0 to %c4 step %c1 iter_args(%tok = %token, %acc = %c0) -> (!amdgcn.read_token<flat>, index) {
    ...
    %result2, %token2 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig30)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @cf_args(%arg0: !amdgcn.vgpr<[? + 2]>, %cond: i1)  -> !amdgcn.read_token<flat> {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig31)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
^bb1(%1: !amdgcn.read_token<flat>):
  ...
  %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig32)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
^bb2(%2: !amdgcn.read_token<flat>):
  ...
  %3 = scf.if %cond -> (!amdgcn.read_token<flat>) {
    ...
    %result_2, %token_2 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig33)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token_2 : !amdgcn.read_token<flat>
  } else {
    %c0_i32_mig34 = arith.constant 0 : i32
    %result_2, %token_2 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig34)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token_2 : !amdgcn.read_token<flat>
  }
...
func.func @wait_on_mixed_real_and_poison(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig35)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %poison = ub.poison : !amdgcn.read_token<flat>
...
func.func @for_with_poison_init(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  %out = scf.for %i = %c0 to %c4 step %c1 iter_args(%tok = %poison) -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig36)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.ds_read_b32 outs(%[[ALLOCA_0]]) ins(%[[ARG0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           %[[VAL_1:.*]], %[[LOAD_1:.*]] = amdgcn.ds_read_b32 outs(%[[ALLOCA_0]]) ins(%[[ARG0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           %[[VAL_2:.*]], %[[LOAD_2:.*]] = amdgcn.ds_read_b32 outs(%[[ALLOCA_0]]) ins(%[[ARG0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           %[[VAL_3:.*]], %[[LOAD_3:.*]] = amdgcn.ds_read_b32 outs(%[[ALLOCA_0]]) ins(%[[ARG0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
...
func.func @test_wait_canonicalization(%addr: !amdgcn.vgpr) {
  %1 = amdgcn.alloca : !amdgcn.vgpr
  %c0_i32_mig3 = arith.constant 0 : i32
  %result_0, %token = amdgcn.ds_read_b32 outs(%1) ins(%addr) args(%c0_i32_mig3)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
  %2 = amdgcn.alloca : !amdgcn.vgpr
  %c0_i32_mig4 = arith.constant 0 : i32
  %result_1, %token_1 = amdgcn.ds_read_b32 outs(%1) ins(%addr) args(%c0_i32_mig4)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
  %3 = amdgcn.alloca : !amdgcn.vgpr
  %c0_i32_mig5 = arith.constant 0 : i32
  %result_2, %token_2 = amdgcn.ds_read_b32 outs(%1) ins(%addr) args(%c0_i32_mig5)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
  %4 = amdgcn.alloca : !amdgcn.vgpr
  %c0_i32_mig6 = arith.constant 0 : i32
  %result_3, %token_3 = amdgcn.ds_read_b32 outs(%1) ins(%addr) args(%c0_i32_mig6)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
