...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.global_load_dword outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr
// CHECK:         }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.global_load_dword outs(%[[ARG0]]) ins(%[[ARG1]]) args(%[[CONSTANT_0]]) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr
// CHECK:         }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.global_load_dwordx2 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[? + 2]>) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr<[? + 2]>
// CHECK:         }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.global_load_dwordx3 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[? + 3]>) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.global_load_dwordx4 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[? + 4]>) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.s_load_dword outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
// CHECK:           return %[[VAL_0]] : !amdgcn.sgpr
// CHECK:         }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.s_load_dword outs(%[[ARG0]]) ins(%[[ARG1]]) args(%[[CONSTANT_0]]) : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
// CHECK:           return %[[VAL_0]] : !amdgcn.sgpr
// CHECK:         }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.s_load_dwordx2 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.sgpr<[? + 2]>) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
// CHECK:           return %[[VAL_0]] : !amdgcn.sgpr<[? + 2]>
// CHECK:         }
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.s_load_dwordx4 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.sgpr<[? + 4]>) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.s_load_dwordx8 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.sgpr<[? + 8]>) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
...
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.s_load_dwordx16 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%{{.*}}) : outs(!amdgcn.sgpr<[? + 16]>) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.ds_read_b32 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%[[CONSTANT_0]]) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.ds_read_b64 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%[[CONSTANT_0]]) : outs(!amdgcn.vgpr<[? + 2]>) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr<[? + 2]>
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.ds_read_b96 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%[[CONSTANT_0]]) : outs(!amdgcn.vgpr<[? + 3]>) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr<[? + 3]>
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[VAL_0:.*]], %[[LOAD_0:.*]] = amdgcn.ds_read_b128 outs(%[[ARG0]]) ins(%[[ARG1]]) args(%[[CONSTANT_0]]) : outs(!amdgcn.vgpr<[? + 4]>) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
// CHECK:           return %[[VAL_0]] : !amdgcn.vgpr<[? + 4]>
// CHECK:         }
...
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dword ins(%[[ARG0]], %[[ARG1]]) args(%{{.*}}) : ins(!amdgcn.vgpr, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           return
// CHECK:         }
...
// CHECK-SAME:      %[[ARG0:.*]]: !amdgcn.vgpr, %[[ARG1:.*]]: !amdgcn.vgpr<[? + 2]>) {
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 16 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dword ins(%[[ARG0]], %[[ARG1]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.vgpr, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dwordx2 ins(%[[ARG0]], %[[ARG1]]) args(%{{.*}}) : ins(!amdgcn.vgpr<[? + 2]>, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dwordx3 ins(%[[ARG0]], %[[ARG1]]) args(%{{.*}}) : ins(!amdgcn.vgpr<[? + 3]>, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dwordx4 ins(%[[ARG0]], %[[ARG1]]) args(%{{.*}}) : ins(!amdgcn.vgpr<[? + 4]>, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.s_store_dword ins(%[[ARG0]], %[[ARG1]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.sgpr, !amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<constant>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.s_store_dwordx2 ins(%[[ARG0]], %[[ARG1]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.sgpr<[? + 2]>, !amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<constant>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.s_store_dwordx4 ins(%[[ARG0]], %[[ARG1]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.sgpr<[? + 4]>, !amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<constant>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.ds_write_b32 ins(%[[ARG1]], %[[ARG0]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.vgpr, !amdgcn.vgpr) args(i32) -> !amdgcn.write_token<shared>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.ds_write_b64 ins(%[[ARG1]], %[[ARG0]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.vgpr, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<shared>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.ds_write_b96 ins(%[[ARG1]], %[[ARG0]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.vgpr, !amdgcn.vgpr<[? + 3]>) args(i32) -> !amdgcn.write_token<shared>
// CHECK:           return
// CHECK:         }
...
// CHECK:           %[[CONSTANT_0:.*]] = arith.constant 0 : i32
// CHECK:           %[[STORE_0:.*]] = amdgcn.ds_write_b128 ins(%[[ARG1]], %[[ARG0]]) args(%[[CONSTANT_0]]) : ins(!amdgcn.vgpr, !amdgcn.vgpr<[? + 4]>) args(i32) -> !amdgcn.write_token<shared>
// CHECK:           return
// CHECK:         }
...
module attributes {dlti.dl_spec = #dlti.dl_spec<!ptr.ptr<#amdgcn.addr_space<local, read_write>> = #ptr.spec<size = 32, abi = 32, preferred = 32>, !ptr.ptr<#amdgcn.addr_space<global, read_write>> = #ptr.spec<size = 64, abi = 64, preferred = 64>>} {
  amdgcn.module @test_module target = <gfx942> {
    func.func @test_load(%arg0: !amdgcn.sgpr<[? + 2]>) attributes {gpu.host_abi = {align = array<i32: 8>, size = array<i32: 8>, type = (!ptr.ptr<#amdgcn.addr_space<global, read_write>>) -> ()}, gpu.kernel} {
      ...
      %dest_res, %token = amdgcn.global_load_dword outs(%10) ins(%arg0, offset = %9) args(%c0_i32_mig1)
