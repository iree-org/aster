...
// CHECK:           %[[LOAD_0:.*]] = amdgcn.global_load_dword outs(%[[ALLOCA_2]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.br ^bb1
// CHECK:         ^bb1:
// CHECK:           amdgcn.test_inst ins %[[ALLOCA_2]] : (!amdgcn.vgpr<2>) -> ()
// CHECK:           %[[LOAD_1:.*]] = amdgcn.global_load_dword outs(%[[ALLOCA_2]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @two_stage_load_basic() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%5) args(%c0_i32_mig1)
...
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_0 = amdgcn.global_load_dword outs(%3) ins(%5) args(%c0_i32_mig2)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
...
// CHECK:           %[[MAKE_REGISTER_RANGE_0:.*]] = amdgcn.make_register_range %[[ALLOCA_0]], %[[ALLOCA_1]] : !amdgcn.vgpr<0>, !amdgcn.vgpr<1>
// CHECK:           %[[LOAD_0:.*]] = amdgcn.global_load_dword outs(%[[ALLOCA_2]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           %[[LOAD_1:.*]] = amdgcn.global_load_dword outs(%[[ALLOCA_3]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<3>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.br ^bb1
// CHECK:         ^bb1:
// CHECK:           amdgcn.test_inst ins %[[ALLOCA_2]], %[[ALLOCA_3]] : (!amdgcn.vgpr<2>, !amdgcn.vgpr<3>) -> ()
// CHECK:           %[[LOAD_2:.*]] = amdgcn.global_load_dword outs(%[[ALLOCA_2]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           %[[LOAD_3:.*]] = amdgcn.global_load_dword outs(%[[ALLOCA_3]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<3>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.cond_br %[[VAL_0]], ^bb1, ^bb2
// CHECK:         ^bb2:
// CHECK:           amdgcn.test_inst ins %[[ALLOCA_2]], %[[ALLOCA_3]] : (!amdgcn.vgpr<2>, !amdgcn.vgpr<3>) -> ()
// CHECK:           return
...
func.func @two_independent_loads() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%7) args(%c0_i32_mig3)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig4 = arith.constant 0 : i32
  %token_0 = amdgcn.global_load_dword outs(%5) ins(%7) args(%c0_i32_mig4)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
...
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_1 = amdgcn.global_load_dword outs(%3) ins(%7) args(%c0_i32_mig5)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig6 = arith.constant 0 : i32
  %token_2 = amdgcn.global_load_dword outs(%5) ins(%7) args(%c0_i32_mig6)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  lsir.copy %6, %5 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.cond_br %0, ^bb1, ^bb2
...
// CHECK:           %[[LOAD_0:.*]] = amdgcn.global_load_dwordx2 outs(%[[MAKE_REGISTER_RANGE_1]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[2 : 4]>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.br ^bb1
// CHECK:         ^bb1:
// CHECK:           amdgcn.test_inst ins %[[MAKE_REGISTER_RANGE_1]] : (!amdgcn.vgpr<[2 : 4]>) -> ()
// CHECK:           %[[LOAD_1:.*]] = amdgcn.global_load_dwordx2 outs(%[[MAKE_REGISTER_RANGE_1]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[2 : 4]>) ins(!amdgcn.vgpr<[0 : 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.cond_br %[[VAL_0]], ^bb1, ^bb2
// CHECK:         ^bb2:
// CHECK:           amdgcn.test_inst ins %[[MAKE_REGISTER_RANGE_1]] : (!amdgcn.vgpr<[2 : 4]>) -> ()
// CHECK:           return
...
func.func @two_stage_load_dwordx2() {
  ...
  %token = amdgcn.global_load_dwordx2 outs(%8) ins(%7) args(%c0_i32_mig7)
...
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_0 = amdgcn.global_load_dwordx2 outs(%8) ins(%7) args(%c0_i32_mig8)
      : outs(!amdgcn.vgpr<[? : ? + 2]>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %9, %8 : !amdgcn.vgpr<[? : ? + 2]>, !amdgcn.vgpr<[? : ? + 2]>
  cf.cond_br %0, ^bb1, ^bb2
^bb2:  // pred: ^bb1
...
func.func @three_stage_load_compute_store() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%6) args(%c0_i32_mig9)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  %c0_i32_mig10 = arith.constant 0 : i32
  %token_0 = amdgcn.global_load_dword outs(%3) ins(%6) args(%c0_i32_mig10)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_1 = amdgcn.global_load_dword outs(%3) ins(%6) args(%c0_i32_mig11)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  amdgcn.test_inst outs %5 ins %4 : (!amdgcn.vgpr<?>, !amdgcn.vgpr<?>) -> ()
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.cond_br %0, ^bb1, ^bb2
...
func.func @pipeline_copy_interferes() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%5) args(%c0_i32_mig12)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.br ^bb1
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_0 = amdgcn.global_load_dword outs(%3) ins(%5) args(%c0_i32_mig13)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.cond_br %0, ^bb1, ^bb2
^bb2:  // pred: ^bb1
...
func.func @mixed_coalesce_and_no_coalesce() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%7) args(%c0_i32_mig14)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig15 = arith.constant 0 : i32
  %token_0 = amdgcn.global_load_dword outs(%5) ins(%7) args(%c0_i32_mig15)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  lsir.copy %6, %5 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.br ^bb1
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_1 = amdgcn.global_load_dword outs(%3) ins(%7) args(%c0_i32_mig16)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig17 = arith.constant 0 : i32
  %token_2 = amdgcn.global_load_dword outs(%5) ins(%7) args(%c0_i32_mig17)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  lsir.copy %6, %5 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.cond_br %0, ^bb1, ^bb2
...
func.func @pipeline_chain_copies() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%6) args(%c0_i32_mig18)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
...
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_0 = amdgcn.global_load_dword outs(%3) ins(%6) args(%c0_i32_mig19)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  lsir.copy %5, %4 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.cond_br %0, ^bb1, ^bb2
...
// CHECK:           %[[LOAD_0:.*]] = amdgcn.global_load_dwordx4 outs(%[[MAKE_REGISTER_RANGE_1]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[0 : 4]>) ins(!amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.br ^bb1
// CHECK:         ^bb1:
// CHECK:           amdgcn.test_inst ins %[[MAKE_REGISTER_RANGE_1]] : (!amdgcn.vgpr<[0 : 4]>) -> ()
// CHECK:           %[[LOAD_1:.*]] = amdgcn.global_load_dwordx4 outs(%[[MAKE_REGISTER_RANGE_1]]) ins(%[[MAKE_REGISTER_RANGE_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr<[0 : 4]>) ins(!amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:           cf.cond_br %[[VAL_0]], ^bb1, ^bb2
// CHECK:         ^bb2:
// CHECK:           amdgcn.test_inst ins %[[MAKE_REGISTER_RANGE_1]] : (!amdgcn.vgpr<[0 : 4]>) -> ()
// CHECK:           return
...
func.func @two_stage_load_dwordx4() {
  ...
  %token = amdgcn.global_load_dwordx4 outs(%12) ins(%11) args(%c0_i32_mig20)
...
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_0 = amdgcn.global_load_dwordx4 outs(%12) ins(%11) args(%c0_i32_mig21)
      : outs(!amdgcn.vgpr<[? : ? + 4]>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %13, %12 : !amdgcn.vgpr<[? : ? + 4]>, !amdgcn.vgpr<[? : ? + 4]>
  cf.cond_br %0, ^bb1, ^bb2
^bb2:  // pred: ^bb1
...
func.func @two_loads_to_compute() {
  ...
  %token = amdgcn.global_load_dword outs(%3) ins(%8) args(%c0_i32_mig22)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig23 = arith.constant 0 : i32
  %token_0 = amdgcn.global_load_dword outs(%5) ins(%8) args(%c0_i32_mig23)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  lsir.copy %6, %5 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.br ^bb1
^bb1:  // 2 preds: ^bb0, ^bb1
  ...
  %token_1 = amdgcn.global_load_dword outs(%3) ins(%8) args(%c0_i32_mig24)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig25 = arith.constant 0 : i32
  %token_2 = amdgcn.global_load_dword outs(%5) ins(%8) args(%c0_i32_mig25)
      : outs(!amdgcn.vgpr<?>) ins(!amdgcn.vgpr<[? : ? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  lsir.copy %4, %3 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  lsir.copy %6, %5 : !amdgcn.vgpr<?>, !amdgcn.vgpr<?>
  cf.cond_br %0, ^bb1, ^bb2
