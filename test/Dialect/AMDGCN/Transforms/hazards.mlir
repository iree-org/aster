...
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dword ins(%[[ARG0]], %[[ARG1]]) args(%{{.*}}) : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           amdgcn.v_nop
// CHECK:           amdgcn.v_nop
...
func.func @test_store_no_hazard(%arg0: !amdgcn.vgpr<0>, %arg1: !amdgcn.vgpr<[4 : 6]>, %arg2: !amdgcn.vgpr<1>) {
  ...
  %0 = amdgcn.global_store_dword ins(%arg0, %arg1) args(%c0_i32_mig2)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  amdgcn.v_nop
  amdgcn.v_nop
  amdgcn.v_mov_b32 outs(%arg0) ins(%arg2) : outs(!amdgcn.vgpr<0>) ins(!amdgcn.vgpr<1>)
...
^bb1:  // pred: ^bb0
  ...
  %0 = amdgcn.global_store_dword ins(%arg0, %arg1) args(%c0_i32_mig3)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  cf.br ^bb2
^bb2:  // 2 preds: ^bb0, ^bb1
  amdgcn.v_mov_b32 outs(%arg0) ins(%arg2) : outs(!amdgcn.vgpr<0>) ins(!amdgcn.vgpr<1>)
...
func.func @test_cf_diamond_hazard(%arg0: !amdgcn.vgpr<0>, %arg1: !amdgcn.vgpr<[4 : 6]>, %arg2: !amdgcn.vgpr<1>, %arg3: i1) {
  ...
  %0 = amdgcn.global_store_dword ins(%arg0, %arg1) args(%c0_i32_mig4)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  cf.cond_br %arg3, ^bb1, ^bb2
^bb1:  // pred: ^bb0
  amdgcn.v_mov_b32 outs(%arg0) ins(%arg2) : outs(!amdgcn.vgpr<0>) ins(!amdgcn.vgpr<1>)
...
^bb1:  // pred: ^bb0
  ...
  %0 = amdgcn.global_store_dword ins(%arg0, %arg1) args(%c0_i32_mig5)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  amdgcn.v_nop
  cf.br ^bb2
^bb2:  // 2 preds: ^bb0, ^bb1
...
// CHECK:           %[[STORE_0:.*]] = amdgcn.global_store_dword ins(%[[ARG0]], %[[ARG2]]) args(%{{.*}}) : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           %[[STORE_1:.*]] = amdgcn.global_store_dword ins(%[[ARG1]], %[[ARG2]]) args(%{{.*}}) : ins(!amdgcn.vgpr<1>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:           amdgcn.v_nop
...
func.func @test_hazard_optimality(%arg0: !amdgcn.vgpr<0>, %arg1: !amdgcn.vgpr<1>, %arg2: !amdgcn.vgpr<[4 : 6]>, %arg3: !amdgcn.vgpr<1>) {
  ...
  %0 = amdgcn.global_store_dword ins(%arg0, %arg2) args(%c0_i32_mig6)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  %c0_i32_mig7 = arith.constant 0 : i32
  %1 = amdgcn.global_store_dword ins(%arg1, %arg2) args(%c0_i32_mig7)
      : ins(!amdgcn.vgpr<1>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
...
^bb1:
  ...
  %token = amdgcn.global_store_dword ins(%data, %addr) args(%c0_i32_mig8)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
...
^bb1:
  ...
  %token = amdgcn.global_store_dword ins(%data, %addr) args(%c0_i32_mig9)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  amdgcn.v_nop
  cf.cond_br %cond , ^bb1, ^bb2
^bb2:
...
^bb1:
  ...
  %token = amdgcn.global_store_dword ins(%data, %addr) args(%c0_i32_mig10)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  amdgcn.v_nop
  cf.cond_br %cond , ^bb1, ^bb2
^bb2:
...
^bb1:
  ...
  %token = amdgcn.global_store_dword ins(%data, %addr) args(%c0_i32_mig11)
      : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  amdgcn.v_nop
  amdgcn.v_nop
  cf.cond_br %cond , ^bb1, ^bb2
