...
func.func @test_ds_read_b32(%addr: !amdgcn.vgpr, %d: !amdgcn.vgpr_range<[? + 1]>) -> !amdgcn.vgpr {
  %result = amdgcn.ds.read #amdgcn.inst<ds_read_b32> %d, %addr : !amdgcn.vgpr -> !amdgcn.vgpr_range<[? + 1]>
...
func.func @test_ds_read_b32_with_offset(%addr: !amdgcn.vgpr, %dst1: !amdgcn.vgpr_range<[? + 1]>) -> !amdgcn.vgpr {
  %result = amdgcn.ds.read #amdgcn.inst<ds_read_b32> %dst1, %addr, offset = 4 : !amdgcn.vgpr -> !amdgcn.vgpr_range<[? + 1]>
  %0 = amdgcn.split_register_range %result : !amdgcn.vgpr_range<[? + 1]>
  return %0 : !amdgcn.vgpr
}

func.func @test_ds_read_b64(%addr: !amdgcn.vgpr, %dst2: !amdgcn.vgpr_range<[? + 2]>) -> (!amdgcn.vgpr, !amdgcn.vgpr) {
  %result = amdgcn.ds.read #amdgcn.inst<ds_read_b64> %dst2, %addr : !amdgcn.vgpr -> !amdgcn.vgpr_range<[? + 2]>
...
func.func @test_ds_read_b96(%addr: !amdgcn.vgpr, %dst3: !amdgcn.vgpr_range<[? + 3]>) -> (!amdgcn.vgpr, !amdgcn.vgpr, !amdgcn.vgpr) {
  %result = amdgcn.ds.read #amdgcn.inst<ds_read_b96> %dst3, %addr : !amdgcn.vgpr -> !amdgcn.vgpr_range<[? + 3]>
...
func.func @test_ds_read_b128(%addr: !amdgcn.vgpr, %dst4: !amdgcn.vgpr_range<[? + 4]>) -> (!amdgcn.vgpr, !amdgcn.vgpr, !amdgcn.vgpr, !amdgcn.vgpr) {
  %result = amdgcn.ds.read #amdgcn.inst<ds_read_b128> %dst4, %addr : !amdgcn.vgpr -> !amdgcn.vgpr_range<[? + 4]>
...
func.func @test_ds_write_b32(%addr: !amdgcn.vgpr, %val: !amdgcn.vgpr) {
  ...
  amdgcn.ds.write #amdgcn.inst<ds_write_b32> %val_range, %addr : !amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr
  return
}

func.func @test_ds_write_b32_with_offset(%addr: !amdgcn.vgpr, %val: !amdgcn.vgpr) {
  %val_range = amdgcn.make_register_range %val : !amdgcn.vgpr
  amdgcn.ds.write #amdgcn.inst<ds_write_b32> %val_range, %addr, offset = 8 : !amdgcn.vgpr_range<[? + 1]>, !amdgcn.vgpr
  return
}
...
func.func @test_ds_write_b64(%addr: !amdgcn.vgpr, %val0: !amdgcn.vgpr, %val1: !amdgcn.vgpr) {
  ...
  amdgcn.ds.write #amdgcn.inst<ds_write_b64> %val_range, %addr : !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr
  return
}

func.func @test_ds_write_b64_with_offset(%addr: !amdgcn.vgpr, %val0: !amdgcn.vgpr, %val1: !amdgcn.vgpr) {
  %val_range = amdgcn.make_register_range %val0, %val1 : !amdgcn.vgpr, !amdgcn.vgpr
  amdgcn.ds.write #amdgcn.inst<ds_write_b64> %val_range, %addr, offset = 16 : !amdgcn.vgpr_range<[? + 2]>, !amdgcn.vgpr
  return
}
...
func.func @test_ds_write_b96(%addr: !amdgcn.vgpr, %val0: !amdgcn.vgpr, %val1: !amdgcn.vgpr, %val2: !amdgcn.vgpr) {
  ...
  amdgcn.ds.write #amdgcn.inst<ds_write_b96> %val_range, %addr : !amdgcn.vgpr_range<[? + 3]>, !amdgcn.vgpr
  return
}
...
func.func @test_ds_write_b128(%addr: !amdgcn.vgpr, %val0: !amdgcn.vgpr, %val1: !amdgcn.vgpr, %val2: !amdgcn.vgpr, %val3: !amdgcn.vgpr) {
  ...
  amdgcn.ds.write #amdgcn.inst<ds_write_b128> %val_range, %addr : !amdgcn.vgpr_range<[? + 4]>, !amdgcn.vgpr
  return
}
...
func.func @test_vop2_lshrrev_b32_e32_vgpr(%src0: !amdgcn.vgpr, %vsrc1: !amdgcn.vgpr, %dst: !amdgcn.vgpr) -> !amdgcn.vgpr {
  %result = amdgcn.vop2.vop2 #amdgcn.inst<v_lshrrev_b32_e32> %dst, %src0, %vsrc1
...
func.func @test_vop2_lshrrev_b32_e32_sgpr(%src0: !amdgcn.sgpr, %vsrc1: !amdgcn.vgpr, %dst: !amdgcn.vgpr) -> !amdgcn.vgpr {
  %result = amdgcn.vop2.vop2 #amdgcn.inst<v_lshrrev_b32_e32> %dst, %src0, %vsrc1
      : (!amdgcn.vgpr, !amdgcn.sgpr, !amdgcn.vgpr) -> !amdgcn.vgpr
  return %result : !amdgcn.vgpr
}

func.func @test_vop2_lshrrev_b32_e32_imm(%vsrc1: !amdgcn.vgpr, %dst: !amdgcn.vgpr) -> !amdgcn.vgpr {
  %c8 = arith.constant 8 : i32
  %result = amdgcn.vop2.vop2 #amdgcn.inst<v_lshrrev_b32_e32> %dst, %c8, %vsrc1
      : (!amdgcn.vgpr, i32, !amdgcn.vgpr) -> !amdgcn.vgpr
  return %result : !amdgcn.vgpr
}

func.func @test_vop2_lshlrev_b32_e32_vgpr(%src0: !amdgcn.vgpr, %vsrc1: !amdgcn.vgpr, %dst: !amdgcn.vgpr) -> !amdgcn.vgpr {
  %result = amdgcn.vop2.vop2 #amdgcn.inst<v_lshlrev_b32_e32> %dst, %src0, %vsrc1
      : (!amdgcn.vgpr, !amdgcn.vgpr, !amdgcn.vgpr) -> !amdgcn.vgpr
  return %result : !amdgcn.vgpr
}
...
func.func @test_vop2_lshlrev_b32_e32_imm(%vsrc1: !amdgcn.vgpr, %dst: !amdgcn.vgpr) -> !amdgcn.vgpr {
  %c8 = arith.constant 8 : i32
  %result = amdgcn.vop2.vop2 #amdgcn.inst<v_lshlrev_b32_e32> %dst, %c8, %vsrc1
      : (!amdgcn.vgpr, i32, !amdgcn.vgpr) -> !amdgcn.vgpr
  return %result : !amdgcn.vgpr
}
