...
func.func @test_store_hazard(%arg0: !amdgcn.vgpr<0>, %arg1: !amdgcn.vgpr<[4 : 6]>, %arg2: !amdgcn.vgpr<1>) {
  ...
  %0 = amdgcn.global_store_dword ins(%arg0, %arg1) args(%c0) : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
...
// CHECK:   HAZARD STATE AFTER: {
// CHECK:     active = [
// CHECK:       {#amdgcn.cdna3_store_hazard, %{{.*}} = amdgcn.global_store_dword ins(%{{.*}}, %{{.*}}) args(%{{.*}}) : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>, 0, {v:1, s:0, ds:0}}
// CHECK:     ]
// CHECK:     nop counts = {v:0, s:0, ds:0}
// CHECK:   }
// CHECK: Op: amdgcn.v_nop
...
// CHECK:     nop counts = {v:0, s:0, ds:0}
// CHECK:   }
// CHECK: Op: %{{.*}} = amdgcn.global_store_dword ins(%{{.*}}, %{{.*}}) args(%{{.*}}) : ins(!amdgcn.vgpr<1>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
// CHECK:   HAZARD STATE AFTER: {
// CHECK:     active = [
// CHECK:       {#amdgcn.cdna3_store_hazard, %{{.*}} = amdgcn.global_store_dword ins(%{{.*}}, %{{.*}}) args(%{{.*}}) : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>, 0, {v:1, s:0, ds:0}},
// CHECK:       {#amdgcn.cdna3_store_write_data_hazard, %{{.*}} = amdgcn.global_store_dword ins(%{{.*}}, %{{.*}}) args(%{{.*}}) : ins(!amdgcn.vgpr<1>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>, 0, {v:1, s:0, ds:0}},
// CHECK:       {#amdgcn.cdna3_store_hazard, %{{.*}} = amdgcn.global_store_dword ins(%{{.*}}, %{{.*}}) args(%{{.*}}) : ins(!amdgcn.vgpr<1>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>, 0, {v:2, s:0, ds:0}}
// CHECK:     ]
// CHECK:     nop counts = {v:0, s:0, ds:0}
// CHECK:   }
// CHECK: Op: amdgcn.v_mov_b32 outs(%{{.*}}) ins(%{{.*}}) : outs(!amdgcn.vgpr<0>) ins(!amdgcn.vgpr<1>)
...
func.func @test_hazard_optimality(%arg0: !amdgcn.vgpr<0>, %arg1: !amdgcn.vgpr<1>, %arg2: !amdgcn.vgpr<[4 : 6]>, %arg3: !amdgcn.vgpr<1>) {
  %c0 = arith.constant 0 : i32
  %0 = amdgcn.global_store_dword ins(%arg0, %arg2) args(%c0) : ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
  %1 = amdgcn.global_store_dword ins(%arg1, %arg2) args(%c0) : ins(!amdgcn.vgpr<1>, !amdgcn.vgpr<[4 : 6]>) args(i32) -> !amdgcn.write_token<flat>
