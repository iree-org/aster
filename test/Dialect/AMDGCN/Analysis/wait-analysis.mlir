...
// CHECK:       Op: %[[R_0:.*]], %[[R_1:.*]] = amdgcn.global_load_dword outs(%[[R_2:.*]]) ins(%[[R_3:.*]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: <Empty>
...
// CHECK:       Op: %[[R_4:.*]] = amdgcn.global_store_dword ins(%[[R_0]], %[[R_3]]) args(%{{.*}}) : ins(!amdgcn.vgpr, !amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.write_token<flat>
...
func.func @test_duplicated_waits() {
  ...
  %result, %token = amdgcn.global_load_dword outs(%4) ins(%2) args(%c0_i32_mig1)
  ...
  amdgcn.wait deps %token : !amdgcn.read_token<flat>
  %5 = amdgcn.global_store_dword ins(%result, %2) args(%c0_i32_mig1)
...
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: <Empty>
// CHECK:       Op: %[[R_1:.*]], %[[R_2:.*]] = amdgcn.global_load_dword outs(%[[R_3:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_2]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_4:.*]], %[[R_5:.*]] = amdgcn.global_load_dword outs(%[[R_3]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       Op: %[[R_6:.*]], %[[R_7:.*]] = amdgcn.global_load_dword outs(%[[R_3]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       Op: %[[R_19:.*]], %[[R_20:.*]] = amdgcn.global_load_dword outs(%[[R_3]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @test_pipelined_pattern(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig2)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig3 = arith.constant 0 : i32
  %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig3)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig4 = arith.constant 0 : i32
  %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig4)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  ...
  %2:3 = scf.for %arg1 = %c0 to %c4 step %c1 iter_args(%arg2 = %token, %arg3 = %token_1, %arg4 = %token_3) -> (!amdgcn.read_token<flat>, !amdgcn.read_token<flat>, !amdgcn.read_token<flat>) {
    ...
    %result_4, %token_5 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig5)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       Op: %[[R_5:.*]], %[[R_6:.*]] = amdgcn.global_load_dword outs(%[[R_7:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @test_escaped_waits_1(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  scf.for %arg1 = %c0 to %c4 step %c1 {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig6)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  }
  return
}
...
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{<escaped>, 0, flat}]
// CHECK:       Op: %[[R_2:.*]], %[[R_3:.*]] = amdgcn.global_load_dword outs(%[[R_4:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: <Empty>
...
func.func @test_escaped_waits_2(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  scf.if %arg1 {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig7)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  }
...
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_2]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_3:.*]], %[[R_4:.*]] = amdgcn.global_load_dword outs(%[[R_5:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: scf.yield %[[R_4]] : !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_3]], %[[R_4]] = amdgcn.global_load_dword outs(%[[R_6:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: scf.yield %[[R_4]] : !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
...
func.func @test_if_flow_1(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  %2 = scf.if %arg1 -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig8)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  } else {
    %c0_i32_mig9 = arith.constant 0 : i32
    %result, %token = amdgcn.global_load_dword outs(%1) ins(%arg0) args(%c0_i32_mig9)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
...
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_6:.*]], %[[R_7:.*]] = amdgcn.global_load_dword outs(%[[R_5]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 1, flat}, {%[[R_7]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_8:.*]], %[[R_9:.*]] = amdgcn.global_load_dword outs(%[[R_5]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 2, flat}, {%[[R_7]], {{[0-9]*}}, 1, flat}, {%[[R_9]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_3]], %[[R_4]] = amdgcn.global_load_dword outs(%[[R_10:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: scf.yield %[[R_4]] : !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, flat}]
...
func.func @test_if_flow_2(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  %2 = scf.if %arg1 -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig10)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig11 = arith.constant 0 : i32
    %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig11)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig12 = arith.constant 0 : i32
    %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig12)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token_3 : !amdgcn.read_token<flat>
  } else {
    %c0_i32_mig13 = arith.constant 0 : i32
    %result, %token = amdgcn.global_load_dword outs(%1) ins(%arg0) args(%c0_i32_mig13)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
  amdgcn.wait deps %2 : !amdgcn.read_token<flat>
...
func.func @test_if_flow_3(%arg0: !amdgcn.vgpr<[? + 2]>, %arg1: i1) {
  ...
  %2 = scf.if %arg1 -> (!amdgcn.read_token<flat>) {
    ...
    %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig14)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig15 = arith.constant 0 : i32
    %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig15)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig16 = arith.constant 0 : i32
    %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig16)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  } else {
    %c0_i32_mig17 = arith.constant 0 : i32
    %result, %token = amdgcn.global_load_dword outs(%1) ins(%arg0) args(%c0_i32_mig17)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    %c0_i32_mig18 = arith.constant 0 : i32
    %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig18)
        : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
    scf.yield %token : !amdgcn.read_token<flat>
  }
  amdgcn.wait deps %2 : !amdgcn.read_token<flat>
...
func.func @test_passthrough_pattern(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig19)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig20 = arith.constant 0 : i32
  %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig20)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig21 = arith.constant 0 : i32
  %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig21)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: <Empty>
// CHECK:       Op: %[[R_3:.*]], %[[R_4:.*]] = amdgcn.s_load_dword outs(%[[R_5:.*]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
// CHECK:       	WAIT STATE BEFORE: <Empty>
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_4]], {{[0-9]*}}, 0, constant}]
// CHECK:       Op: %[[R_6:.*]], %[[R_7:.*]] = amdgcn.ds_read_b32 outs(%[[R_8:.*]]) ins(%[[R_1]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
...
// CHECK:       Op: %[[R_9:.*]], %[[R_10:.*]] = amdgcn.global_load_dword outs(%[[R_8]]) ins(%[[R_2]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @test_mixed_smem_dsmem(%arg0: !amdgcn.sgpr<[? + 2]>, %arg1: !amdgcn.vgpr, %arg2: !amdgcn.vgpr<[? + 2]>) {
  ...
  %c0_i32_mig1 = arith.constant 0 : i32
  %result, %token = amdgcn.s_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig1)
      : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
  %result_0, %token_1 = amdgcn.ds_read_b32 outs(%1) ins(%arg1) args(%c0_i32_mig1)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
  %c0_i32_mig22 = arith.constant 0 : i32
  %result_2, %token_3 = amdgcn.global_load_dword outs(%1) ins(%arg2) args(%c0_i32_mig22)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       Op: %[[R_8:.*]], %[[R_9:.*]] = amdgcn.global_load_dword outs(%[[R_3]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_7]], {{[0-9]*}}, 1, flat}, {%[[R_9]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_10:.*]], %[[R_11:.*]] = amdgcn.global_load_dword outs(%[[R_3]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: unhandled tokens = [{%[[R_7]], {{[0-9]*}}, 1, flat}, {%[[R_9]], {{[0-9]*}}, 0, flat}]
...
// CHECK:       	WAIT STATE AFTER: unhandled tokens = [{%[[R_7]], {{[0-9]*}}, 2, flat}, {%[[R_9]], {{[0-9]*}}, 1, flat}, {%[[R_11]], {{[0-9]*}}, 0, flat}]
// CHECK:       Op: %[[R_12:.*]], %[[R_13:.*]] = amdgcn.global_load_dword outs(%[[R_3]]) ins(%[[R_0]]) args(%{{.*}}) : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
// CHECK:       	WAIT STATE BEFORE: unhandled tokens = [{%[[R_7]], {{[0-9]*}}, 2, flat}, {%[[R_9]], {{[0-9]*}}, 1, flat}, {%[[R_11]], {{[0-9]*}}, 0, flat}]
...
func.func @test_counts_strength(%arg0: !amdgcn.vgpr<[? + 2]>) {
  ...
  %result, %token = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig23)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig24 = arith.constant 0 : i32
  %result_0, %token_1 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig24)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig25 = arith.constant 0 : i32
  %result_2, %token_3 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig25)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  ...
  %result_4, %token_5 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig26)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig27 = arith.constant 0 : i32
  %result_6, %token_7 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig27)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
  %c0_i32_mig28 = arith.constant 0 : i32
  %result_8, %token_9 = amdgcn.global_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig28)
      : outs(!amdgcn.vgpr) ins(!amdgcn.vgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<flat>
...
func.func @test_smem_zero(%arg0: !amdgcn.sgpr<[? + 2]>, %arg1: !amdgcn.vgpr, %arg2: !amdgcn.vgpr<[? + 2]>) {
  ...
  %c0_i32_mig2 = arith.constant 0 : i32
  %dest_res, %token = amdgcn.s_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig2)
      : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
  %c0_i32_mig3 = arith.constant 0 : i32
  %dest_res1, %token_1 = amdgcn.s_load_dword outs(%0) ins(%arg0) args(%c0_i32_mig3)
      : outs(!amdgcn.sgpr) ins(!amdgcn.sgpr<[? + 2]>) args(i32) -> !amdgcn.read_token<constant>
  amdgcn.wait deps %token : !amdgcn.read_token<constant>
  return
}
