...
func.func @sop2_bitwise_negated_ops(%sdst: !amdgcn.sgpr, %lhs: !amdgcn.sgpr, %rhs: !amdgcn.sgpr)
  ...
  // s_andn2_b64 - SOP2 AND with negated second operand (64-bit)
  %andn2_b64 = amdgcn.sop2 s_andn2_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_orn2_b64 - SOP2 OR with negated second operand (64-bit)
  %orn2_b64 = amdgcn.sop2 s_orn2_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_nand_b64 - SOP2 bitwise NAND (64-bit)
  %nand_b64 = amdgcn.sop2 s_nand_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_nor_b64 - SOP2 bitwise NOR (64-bit)
  %nor_b64 = amdgcn.sop2 s_nor_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_xnor_b64 - SOP2 bitwise XNOR (64-bit)
  %xnor_b64 = amdgcn.sop2 s_xnor_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr

  return %andn2_b32, %andn2_b64, %orn2_b32, %orn2_b64, %nand_b32, %nand_b64, %nor_b32, %nor_b64, %xnor_b32, %xnor_b64
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr,
      !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr,
      !amdgcn.sgpr, !amdgcn.sgpr
}
...
func.func @sop2_shift_ops(%sdst: !amdgcn.sgpr, %lhs: !amdgcn.sgpr, %rhs: !amdgcn.sgpr)
  ...
  // s_lshl_b64 - SOP2 logical shift left 64-bit
  %lshl_b64 = amdgcn.sop2 s_lshl_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_lshr_b64 - SOP2 logical shift right 64-bit
  %lshr_b64 = amdgcn.sop2 s_lshr_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_ashr_i64 - SOP2 arithmetic shift right 64-bit
  %ashr_i64 = amdgcn.sop2 s_ashr_i64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr

  return %lshl_b32, %lshl_b64, %lshr_b32, %lshr_b64, %ashr_i32, %ashr_i64
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr,
      !amdgcn.sgpr, !amdgcn.sgpr
}
...
func.func @sop2_bitfield_ops(%sdst: !amdgcn.sgpr, %lhs: !amdgcn.sgpr, %rhs: !amdgcn.sgpr)
  ...
  // s_bfm_b64 - SOP2 create 64-bit bitfield mask
  %bfm_b64 = amdgcn.sop2 s_bfm_b64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr
  ...
  // s_bfe_u64 - SOP2 extract unsigned bitfield from 64-bit
  %bfe_u64 = amdgcn.sop2 s_bfe_u64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr

  // s_bfe_i64 - SOP2 extract signed bitfield from 64-bit
  %bfe_i64 = amdgcn.sop2 s_bfe_i64 outs %sdst ins %lhs, %rhs
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr

  return %bfm_b32, %bfm_b64, %bfe_u32, %bfe_i32, %bfe_u64, %bfe_i64
    : !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr, !amdgcn.sgpr,
      !amdgcn.sgpr, !amdgcn.sgpr
}
