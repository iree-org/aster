...
// A leftover cross_wave_token_barrier (token consumer) is rejected before
// translation; it must be legalized to s_barrier by amdgcn-convert-waits first.
...
// A leftover amdgcn.wait token consumer is likewise rejected.
