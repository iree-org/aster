...
amdgcn.module @perm_mod target = #amdgcn.target<gfx942> {
  ...
  ^entry:
    ...
    %tok = amdgcn.ds_permute_b32 outs(%v2) ins(%v0, %v1) args(%c0)
        : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<1>) args(i32) -> !amdgcn.read_token<shared>
  ...
  ^entry:
    ...
    %tok = amdgcn.ds_permute_b32 outs(%v2) ins(%v0, %v1) args(%c8)
        : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<1>) args(i32) -> !amdgcn.read_token<shared>
    amdgcn.s_waitcnt lgkmcnt = 0
    amdgcn.end_kernel
  }
  ...
  ^entry:
    ...
    %v2 = amdgcn.alloca : !amdgcn.vgpr<2>
    %c0 = arith.constant 0 : i32
    %tok = amdgcn.ds_bpermute_b32 outs(%v2) ins(%v0, %v1) args(%c0)
        : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<1>) args(i32) -> !amdgcn.read_token<shared>
    amdgcn.s_waitcnt lgkmcnt = 0
    amdgcn.end_kernel
  }
  ...
  ^entry:
    ...
    %v2 = amdgcn.alloca : !amdgcn.vgpr<2>
    %c8 = arith.constant 8 : i32
    %tok = amdgcn.ds_bpermute_b32 outs(%v2) ins(%v0, %v1) args(%c8)
        : outs(!amdgcn.vgpr<2>) ins(!amdgcn.vgpr<0>, !amdgcn.vgpr<1>) args(i32) -> !amdgcn.read_token<shared>
    amdgcn.s_waitcnt lgkmcnt = 0
    amdgcn.end_kernel
  }
