...
amdgcn.module @mfma_cdna4_doubled_k_mod target = #amdgcn.target<gfx950> {
  ...
  amdgcn.kernel @mfma_16x16x32_f16_ones arguments <[
    ...
    %result = amdgcn.v_mfma_f32_16x16x32_f16 outs(%dst) ins(%a, %b, %dst)
    : outs(!amdgcn.vgpr<[? + 4]>)
  ...
  amdgcn.kernel @mfma_16x16x32_bf16_ones arguments <[
    ...
    %result = amdgcn.v_mfma_f32_16x16x32_bf16 outs(%dst) ins(%a, %b, %dst)
    : outs(!amdgcn.vgpr<[? + 4]>)
      ins(!amdgcn.vgpr<[? + 4]>, !amdgcn.vgpr<[? + 4]>, !amdgcn.vgpr<[? + 4]>)
  ...
  amdgcn.kernel @mfma_32x32x16_bf16_ones arguments <[
    ...
    %result = amdgcn.v_mfma_f32_32x32x16_bf16 outs(%acc) ins(%a, %b, %acc)
    : outs(!amdgcn.vgpr<[? + 16]>)
  ...
  amdgcn.kernel @mfma_32x32x16_f16_ones arguments <[
    ...
    %result = amdgcn.v_mfma_f32_32x32x16_f16 outs(%acc) ins(%a, %b, %acc)
    : outs(!amdgcn.vgpr<[? + 16]>)
      ins(!amdgcn.vgpr<[? + 4]>, !amdgcn.vgpr<[? + 4]>, !amdgcn.vgpr<[? + 16]>)
