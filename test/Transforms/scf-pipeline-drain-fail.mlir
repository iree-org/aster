...
// CHECK:             buffer_load_lds_dwordx4 ins(%[[BUFA]]
// CHECK:             buffer_load_lds_dwordx4 ins(%[[BUFB]]
...
// CHECK:           buffer_load_lds_dwordx4 ins(%[[BUFB]]
// CHECK-NOT:       buffer_load_lds_dwordx4 ins(%[[BUFA]]
...
module {
  amdgcn.module @gemm_cdna4_mod target = <gfx950> {
    func.func private @_read_b(%arg0: index) -> (!aster_utils.any, !aster_utils.any, !amdgcn.read_token<shared>, !amdgcn.read_token<shared>) {
      ...
      %dest_res, %token = amdgcn.ds_read_b64 outs(%9) ins(%11) args(%c0_i32)
      ...
      %dest_res_0, %token_1 = amdgcn.ds_read_b64 outs(%21) ins(%23) args(%c0_i32)
          : outs(!amdgcn.vgpr<[? + 2]>) ins(!amdgcn.vgpr) args(i32) -> !amdgcn.read_token<shared>
    ...
    kernel @gemm_cdna4 arguments <[#amdgcn.buffer_arg<access = read_only>, #amdgcn.buffer_arg<access = read_only>, #amdgcn.buffer_arg<access = write_only>]> attributes {block_dims = array<i32: 64, 1, 1>, grid_dims = array<i32: 1, 1, 1>} {
      ...
      scf.for %arg0 = %c0 to %c4 step %c1 {
        ...
        %61 = amdgcn.buffer_load_lds_dwordx4 ins(%7, off_or_idx = %60, %10, %11) args(%c0_i32) {offen, sched.stage = 0 : i32}
        ...
        %67 = amdgcn.buffer_load_lds_dwordx4 ins(%8, off_or_idx = %66, %10, %11) args(%c0_i32) {offen, sched.stage = 1 : i32}
            : ins(!amdgcn.sgpr<[? + 4]>, off_or_idx = !amdgcn.vgpr, !amdgcn.sgpr, !amdgcn.m0<0>) args(i32) -> !amdgcn.read_token<flat>
