...
// Two-stage pipeline:
//   stage 0 = load        -> %data
//   stage 1 = compute     -> %new_acc (consumes %acc loop-carried and %data)
// rotate-stage=1 puts compute at the head of the kernel body. Stages are
// preserved (each op still computes for IV - stage*step), and the data
// cross-stage value (load -> compute, distance 1) is carried via an
// iter_arg shift register of depth 1.
