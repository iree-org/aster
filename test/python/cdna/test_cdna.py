...
def build_test_module(ctx: ir.Context) -> builtin.ModuleOp:
    ...
    with ir.InsertionPoint(module.body):
        ...
        # CHECK:             amdgcn.ds.write <ds_write_b32> %[[VAL_6]], %[[VAL_0]] : <[? + 1]>
        ...
        # CHECK:             amdgcn.ds.write <ds_write_b64> %[[VAL_8]], %[[VAL_0]] : <[? + 2]>
        ...
        # CHECK:             amdgcn.ds.write <ds_write_b96> %[[VAL_10]], %[[VAL_0]], offset = 4 : <[? + 3]>
        ...
        # CHECK:             amdgcn.ds.write <ds_write_b128> %[[VAL_12]], %[[VAL_0]], offset = 8 : <[? + 4]>
        ...
        # CHECK:             %[[VAL_41:.*]] = amdgcn.flat.global_load <global_load_dword> %[[VAL_40]], %[[VAL_38]] : <[? + 1]>, !amdgcn.vgpr_range<[? + 2]> -> <[? + 1]>
        ...
        # CHECK:             %[[VAL_45:.*]] = amdgcn.flat.global_load <global_load_dwordx2> %[[VAL_44]], %[[VAL_38]] : <[? + 2]>, !amdgcn.vgpr_range<[? + 2]> -> <[? + 2]>
        ...
        # CHECK:             %[[VAL_50:.*]] = amdgcn.flat.global_load <global_load_dwordx3> %[[VAL_49]], %[[VAL_38]], offset = 4 : <[? + 3]>, !amdgcn.vgpr_range<[? + 2]> -> <[? + 3]>
        ...
        # CHECK:             %[[VAL_56:.*]] = amdgcn.flat.global_load <global_load_dwordx4> %[[VAL_55]], %[[VAL_38]], offset = 8 : <[? + 4]>, !amdgcn.vgpr_range<[? + 2]> -> <[? + 4]>
        ...
        # CHECK:             %[[VAL_62:.*]] = amdgcn.smem.load <s_load_dword> %[[VAL_61]], %[[VAL_59]] : <[? + 1]>, !amdgcn.sgpr_range<[? + 2]> -> <[? + 1]>
        ...
        # CHECK:             %[[VAL_66:.*]] = amdgcn.smem.load <s_load_dwordx2> %[[VAL_65]], %[[VAL_59]] : <[? + 2]>, !amdgcn.sgpr_range<[? + 2]> -> <[? + 2]>
        ...
        # CHECK:             %[[VAL_77:.*]] = amdgcn.smem.load <s_load_dwordx4> %[[VAL_76]], %[[VAL_59]] offset = 8 : <[? + 4]>, !amdgcn.sgpr_range<[? + 2]> -> <[? + 4]>
        ...
        # CHECK:             %[[VAL_81:.*]] = amdgcn.smem.load <s_memtime> %[[VAL_80]] : <[? + 2]> -> <[? + 2]>
        with ir.InsertionPoint(amdgcn_mod.body_region.blocks[0]):
        ...
        # CHECK:             %[[VAL_85:.*]] = amdgcn.vop2.vop2 <v_lshrrev_b32_e32> %[[VAL_84]], %[[VAL_82]], %[[VAL_83]] : (!amdgcn.vgpr, !amdgcn.vgpr, !amdgcn.vgpr) -> !amdgcn.vgpr
        # CHECK:             %[[VAL_86:.*]] = alloca : !amdgcn.sgpr
        # CHECK:             %[[VAL_87:.*]] = amdgcn.vop2.vop2 <v_lshrrev_b32_e32> %[[VAL_84]], %[[VAL_86]], %[[VAL_83]] : (!amdgcn.vgpr, !amdgcn.sgpr, !amdgcn.vgpr) -> !amdgcn.vgpr
        # CHECK:             %[[VAL_88:.*]] = arith.constant 8 : i32
        # CHECK:             %[[VAL_89:.*]] = amdgcn.vop2.vop2 <v_lshrrev_b32_e32> %[[VAL_84]], %[[VAL_88]], %[[VAL_83]] : (!amdgcn.vgpr, i32, !amdgcn.vgpr) -> !amdgcn.vgpr
        # CHECK:             %[[VAL_90:.*]] = amdgcn.vop2.vop2 <v_lshlrev_b32_e32> %[[VAL_84]], %[[VAL_82]], %[[VAL_83]] : (!amdgcn.vgpr, !amdgcn.vgpr, !amdgcn.vgpr) -> !amdgcn.vgpr
        # CHECK:             %[[VAL_91:.*]] = amdgcn.vop2.vop2 <v_lshlrev_b32_e32> %[[VAL_84]], %[[VAL_86]], %[[VAL_83]] : (!amdgcn.vgpr, !amdgcn.sgpr, !amdgcn.vgpr) -> !amdgcn.vgpr
        # CHECK:             %[[VAL_92:.*]] = amdgcn.vop2.vop2 <v_lshlrev_b32_e32> %[[VAL_84]], %[[VAL_88]], %[[VAL_83]] : (!amdgcn.vgpr, i32, !amdgcn.vgpr) -> !amdgcn.vgpr
        with ir.InsertionPoint(amdgcn_mod.body_region.blocks[0]):
