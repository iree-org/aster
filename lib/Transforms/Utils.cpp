...
void mlir::aster::populateArithConversionPatterns(TypeConverter &converter,
  ...
  target.addDynamicallyLegalOp<
      ...
      arith::ExtUIOp, arith::IndexCastOp, arith::MaximumFOp, arith::MaxSIOp,
  ...
  patterns.add<
      ...
      GenericOpConversion<arith::AndIOp>, GenericOpConversion<arith::CmpFOp>,
      ...
      GenericOpConversion<arith::ExtUIOp>,
