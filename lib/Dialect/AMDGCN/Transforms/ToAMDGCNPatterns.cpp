...
struct AddIOpPattern : public OpRewritePattern<pir::AddIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::AddIOp op,
...
struct AllocaOpPattern : public OpRewritePattern<pir::AllocaOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::AllocaOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct AndIOpPattern : public OpRewritePattern<pir::AndIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::AndIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct LoadOpPattern : public OpRewritePattern<pir::LoadOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::LoadOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct MulIOpPattern : public OpRewritePattern<pir::MulIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::MulIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct OrIOpPattern : public OpRewritePattern<pir::OrIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::OrIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct RegCastOpPattern : public OpRewritePattern<pir::RegCastOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::RegCastOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct ShLIOpPattern : public OpRewritePattern<pir::ShLIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::ShLIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct ShRSIOpPattern : public OpRewritePattern<pir::ShRSIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::ShRSIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct ShRUIOpPattern : public OpRewritePattern<pir::ShRUIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::ShRUIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct StoreOpPattern : public OpRewritePattern<pir::StoreOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::StoreOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct SubIOpPattern : public OpRewritePattern<pir::SubIOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::SubIOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct TimingStartOpPattern : public OpRewritePattern<pir::TimingStartOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::TimingStartOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct TimingStopOpPattern : public OpRewritePattern<pir::TimingStopOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::TimingStopOp op,
                                PatternRewriter &rewriter) const override;
};
...
struct WaitOpPattern : public OpRewritePattern<pir::WaitOp> {
  using Base::Base;
  LogicalResult matchAndRewrite(pir::WaitOp op,
                                PatternRewriter &rewriter) const override;
};
} // namespace
...
LogicalResult AddIOpPattern::matchAndRewrite(pir::AddIOp op,
...
LogicalResult
AllocaOpPattern::matchAndRewrite(pir::AllocaOp op,
                                 PatternRewriter &rewriter) const {
  // Check that the output type is an AMDGCN register type
...
LogicalResult AndIOpPattern::matchAndRewrite(pir::AndIOp op,
                                             PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult LoadOpPattern::matchAndRewrite(pir::LoadOp op,
                                             PatternRewriter &rewriter) const {
...
LogicalResult MulIOpPattern::matchAndRewrite(pir::MulIOp op,
                                             PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult OrIOpPattern::matchAndRewrite(pir::OrIOp op,
                                            PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult
RegCastOpPattern::matchAndRewrite(pir::RegCastOp op,
                                  PatternRewriter &rewriter) const {
  Location loc = op.getLoc();
...
LogicalResult ShLIOpPattern::matchAndRewrite(pir::ShLIOp op,
                                             PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult ShRSIOpPattern::matchAndRewrite(pir::ShRSIOp op,
                                              PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult ShRUIOpPattern::matchAndRewrite(pir::ShRUIOp op,
                                              PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult StoreOpPattern::matchAndRewrite(pir::StoreOp op,
                                              PatternRewriter &rewriter) const {
...
LogicalResult SubIOpPattern::matchAndRewrite(pir::SubIOp op,
                                             PatternRewriter &rewriter) const {
  RegisterTypeInterface oTy = op.getType();
  Value dst = op.getDst();
  Value lhs = op.getLhs();
...
LogicalResult
TimingStartOpPattern::matchAndRewrite(pir::TimingStartOp op,
                                      PatternRewriter &rewriter) const {
  Location loc = op.getLoc();
...
LogicalResult
TimingStopOpPattern::matchAndRewrite(pir::TimingStopOp op,
                                     PatternRewriter &rewriter) const {
  Location loc = op.getLoc();
...
static MemOpKind classifyMemOp(Operation *op) {
  MemOpKind kind = classifyMemOp<pir::LoadOp>(op);
  if (kind != MemOpKind::Unknown)
    return kind;
  kind = classifyMemOp<pir::StoreOp>(op);
  if (kind != MemOpKind::Unknown)
    return kind;
  return MemOpKind::Unknown;
}

LogicalResult WaitOpPattern::matchAndRewrite(pir::WaitOp op,
                                             PatternRewriter &rewriter) const {
  Location loc = op.getLoc();
  int32_t vmcnt = 0;
  int32_t lgkmcnt = 0;
