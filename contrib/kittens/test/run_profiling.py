...
ALL_TESTS = [
    ...
    ("gemm_fp16_mt_lds_pipe_ps1_k64",             MTLDSP().test_gemm_multitile_lds_pipelined,      [], {"k": 64, "pipeline_strategy": 1}),
    ("gemm_fp16_mt_lds_pipe_ps1_k128",            MTLDSP().test_gemm_multitile_lds_pipelined,      [], {"k": 128, "pipeline_strategy": 1}),
    ("gemm_fp16_mt_lds_pipe_ps3_k64",             MTLDSP().test_gemm_multitile_lds_pipelined,      [], {"k": 64, "pipeline_strategy": 3}),
    ("gemm_fp16_mt_lds_pipe_ps3_k128",            MTLDSP().test_gemm_multitile_lds_pipelined,      [], {"k": 128, "pipeline_strategy": 3}),
    ("gemm_fp16_lds_pipe_ps1_k64",                LDSP().test_gemm_lds_pipelined,                   [], {"k": 64, "pipeline_strategy": 1}),
    ("gemm_fp16_lds_pipe_ps1_k128",               LDSP().test_gemm_lds_pipelined,                   [], {"k": 128, "pipeline_strategy": 1}),
    ("gemm_fp16_lds_pipe_ps3_k64",                LDSP().test_gemm_lds_pipelined,                   [], {"k": 64, "pipeline_strategy": 3}),
    ("gemm_fp16_lds_pipe_ps3_k128",               LDSP().test_gemm_lds_pipelined,                   [], {"k": 128, "pipeline_strategy": 3}),
    ("gemm_fp16_4wave_lds_pipe_ps1_k64",          G4WLDSP().test_gemm_4wave_lds_pipelined,          [], {"k": 64, "pipeline_strategy": 1}),
    ("gemm_fp16_4wave_lds_pipe_ps1_k128",         G4WLDSP().test_gemm_4wave_lds_pipelined,          [], {"k": 128, "pipeline_strategy": 1}),
    ("gemm_fp16_4wave_lds_pipe_ps3_k64",          G4WLDSP().test_gemm_4wave_lds_pipelined,          [], {"k": 64, "pipeline_strategy": 3}),
    ("gemm_fp16_4wave_lds_pipe_ps3_k128",         G4WLDSP().test_gemm_4wave_lds_pipelined,          [], {"k": 128, "pipeline_strategy": 3}),
    # Weak-scaling correctness (representative configs)
    ("ws_correctness_2x2_2s",                    WSCorr().test_correctness,                       [], {"num_workgroups_per_kernel": [1, 1, 1], "num_waves_per_wg": [1, 1, 1], "num_tiles_per_wg": [2, 2, 1], "pipeline_strategy": 1}),
    ("ws_correctness_4x4_3s",                    WSCorr().test_correctness,                       [], {"num_workgroups_per_kernel": [1, 1, 1], "num_waves_per_wg": [2, 2, 1], "num_tiles_per_wg": [4, 4, 1], "pipeline_strategy": 3}),
