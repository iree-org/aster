...
class TestResourceEstimates:
    ...
    _CONFIGS = [
        ...
        ([1, 1, 1], [1, 1, 1], [3, 2, 1], 4, 1, False, "1w_ps1_lds"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 1, False, "4w_ps1_lds"),
        ([1, 1, 1], [4, 2, 1], [8, 8, 1], 2, 1, False, "8w_ps1_lds"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 3, False, "4w_ps3_lds"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 5, False, "4w_ps5_lds"),
        # -- LDS path, lds_at_write=True --
        ([1, 1, 1], [1, 1, 1], [3, 2, 1], 4, 1, True, "1w_ps1_lds_write"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 1, True, "4w_ps1_lds_write"),
        ([1, 1, 1], [4, 2, 1], [8, 8, 1], 2, 1, True, "8w_ps1_lds_write"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 3, True, "4w_ps3_lds_write"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 5, True, "4w_ps5_lds_write"),
        # -- Asymmetric strategies --
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 2, False, "4w_ps2_lds"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 4, False, "4w_ps4_lds"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 6, False, "4w_ps6_lds"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 2, True, "4w_ps2_lds_write"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 4, True, "4w_ps4_lds_write"),
        ([1, 1, 1], [2, 2, 1], [4, 4, 1], 4, 6, True, "4w_ps6_lds_write"),
    ]
