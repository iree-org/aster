...
def _make_substitutions(cfg: GEMMConfig) -> dict:
    ...
    return {
        ...
        "{{A_STAGE_LOAD}}": str(stage_gl),
        "{{A_STAGE_WRITE}}": str(stage_dw),
        "{{A_STAGE_READ}}": str(stage_dr),
        "{{A_STAGE_COMPUTE}}": str(stage_c),
        "{{B_STAGE_LOAD}}": str(stage_gl),
        "{{B_STAGE_WAIT}}": str(stage_dr),
        "{{B_A_STAGE_COMPUTE}}": str(stage_c),
