...
LogicalResult wave::verifyWaveIndexMappings(Operation *op) {
  ...
  // 1, and (2) when step or stride can be evaluated to a concrete value, that
  ...
  // Default the expected length to the number of op results.
  if (op->getNumResults() != arr.size()) {
