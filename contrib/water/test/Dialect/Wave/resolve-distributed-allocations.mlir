...
// CHECK: water_normalform.module [#wave.normal_form<full_types,resolved_allocations,ordered_syms>]
...
// CHECK: water_normalform.module [#wave.normal_form<resolved_allocations,ordered_syms>]
