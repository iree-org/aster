...
// CHECK: transform.payload attributes {normal_forms = [#wave.normal_form<full_types,resolved_allocations,ordered_syms>]}
...
// CHECK: transform.payload attributes {normal_forms = [#wave.normal_form<resolved_allocations,ordered_syms>]}
