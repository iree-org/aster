...
transform.payload attributes {normal_forms = [#wave.normal_form<full_op_types>]} {
  builtin.module {
    func.func @foo() {
...
transform.payload attributes {normal_forms = [#wave.normal_form<index_exprs>]} {
  builtin.module {
    func.func @bar() {
      %0 = arith.constant 0.0 : f32
...
transform.payload attributes {normal_forms = [#wave.normal_form<resolved_allocations>]} {
  builtin.module {
