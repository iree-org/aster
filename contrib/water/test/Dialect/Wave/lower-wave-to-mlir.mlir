// RUN: water-opt %s -allow-unregistered-dialect -lower-wave-to-mlir -lower-water_normalform-module --mlir-print-local-scope --split-input-file --verify-diagnostics | FileCheck %s
...
water_normalform.module [#wave.normal_form<full_types,index_exprs,memory_only_types,resolved_allocations,ordered_syms>] {
  // CHECK-LABEL: func.func @test_water_normalform_module_lowered
  func.func @test_water_normalform_module_lowered() attributes {wave.hyperparameters = #wave.hyperparameters<{}>} {
    return
  }
}
